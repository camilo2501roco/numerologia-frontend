  ...
  <div class="user-dashboard">
    ...
    <section class="welcome-section">
      ...
      <h1 class="welcome-title">
        Las estrellas se han alineado para ti,
        <span class="welcome-name">{{ authStore.nombreUsuario }}.</span>
      </h1>
      <p class="welcome-desc">
        Tu carta numerológica está lista para ser revelada.
        Descubre los patrones ocultos del viaje de tu alma.
      </p>
    </section>
    ...
    <section class="reading-section" v-if="!lecturaPrincipal">
      <div class="reading-orb" @click="handleGenerarLectura" :class="{ 'reading-orb--loading': generando }">
        <div class="reading-orb__glow"></div>
        <div class="reading-orb__inner">
          <img v-if="!generando" src="@/assets/icono/logo.svg" alt="Logo" class="reading-orb__icon" />
          <q-spinner-dots v-else color="white" size="32px" />
          <span class="reading-orb__text">{{ generando ? 'CONSULTANDO...' : 'GENERAR LECTURA' }}</span>
      ...
      <div class="reading-tags">
        <span class="reading-tag">★ DESTINO</span>
        <span class="reading-tag-dot">•</span>
        <span class="reading-tag">♥ PERSONALIDAD</span>
        <span class="reading-tag-dot">•</span>
        <span class="reading-tag">↑ EXPRESIÓN</span>
      </div>
    </section>

    <!-- ═══ Lectura ya generada (compacta) ═══ -->
    ...
    <section class="daily-section">
      <div class="daily-section__header">
        <h2 class="daily-section__title">
          ...
          Tu Alineación Diaria
        </h2>
        <p class="daily-section__desc">Insights para tu ciclo personal del año.</p>
      </div>
      ...
      <div class="glass-card daily-locked">
        ...
        <div class="daily-locked__overlay">
          ...
          <h3 class="daily-locked__title">Desbloquea Tu Pronóstico Diario</h3>
          <p class="daily-locked__desc">
            Sumérgete en tus lecturas energéticas diarias. Suscríbete a Premium
            para acceder a tu carta numerológica personalizada diaria, semanal y mensual.
          </p>
          <button class="premium-cta" @click="handlePremiumClick">
            Suscribirse a Premium →
          </button>
          <p class="daily-locked__price">Próximamente • Membresía mensual</p>
        </div>
      </div>
    </section>
    ...
    <section class="profile-section">
      <div class="glass-card profile-card">
        ...
        <div class="profile-card__grid">
          ...
          <div class="profile-field">
            <span class="profile-field__label">Miembro desde</span>
      ...
      <div v-if="showReadingModal && lecturaPrincipal" class="reading-modal-overlay" @click.self="showReadingModal = false">
        <div class="reading-modal">
          ...
          <div class="reading-modal__header">
            <p class="reading-modal__badge">ANÁLISIS COMPLETO</p>
            <h2 class="reading-modal__title">El Mapa de Tu Alma</h2>
            <p class="reading-modal__subtitle">
              La aritmética cósmica de tu fecha de nacimiento revela los patrones ocultos de tu existencia.
            </p>
          </div>
          ...
          <div class="reading-modal__content" v-html="formattedReading"></div>

          <!-- Footer -->
          <div class="reading-modal__footer">
            <button class="reading-modal__close-btn" @click="showReadingModal = false">
              Cerrar Lectura ✦
            </button>
          </div>
        </div>
